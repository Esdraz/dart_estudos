void main() {
  ...
  var f5 =
      Future.delayed(Duration(milliseconds: 100), () => Future.error('Error'));

  // .any -> pega o primeiro que for executado e retorna, porém ele não cancela a
  // execução dos outros, ele só ignora o resto
